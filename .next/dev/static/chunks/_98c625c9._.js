...
"[project]/components/wallet-provider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const uniqueWallets = walletAdapters.filter((wallet, index, self)=>index === self.findIndex((w)=>w.name === wallet.name));
const SolanaWalletProvider = ({ children })=>{
    ...
    const endpoint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SolanaWalletProvider.useMemo[endpoint]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clusterApiUrl"])("devnet")
    ...
    const onError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SolanaWalletProvider.useCallback[onError]": (error)=>{
    ...
    }["SolanaWalletProvider.useCallback[onError]"], [
        toast
    ]);
...
_s(SolanaWalletProvider, "/jqfZmF5EapJgy3XCKFB3pCcPlM=", false, function() {
    return [
...
//# sourceMappingURL=_98c625c9._.js.map